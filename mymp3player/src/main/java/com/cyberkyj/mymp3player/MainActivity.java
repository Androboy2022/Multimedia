package com.cyberkyj.mymp3player;
...
public class MainActivity extends AppCompatActivity {
    ...
    String mp3Path = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator;
    MediaPlayer mPlayer;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (File file : listFiles) {
            ...
            if (extName.equals("mp3")) // 확장명이 mp3일 때만 추가함.
                mp3List.add(fileName);
        }

        ListView listViewMP3 = findViewById(R.id.listViewMP3);
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    // handleMessage()가 실행됨. 파라미터 what는 정수형으로 구분하기 위해서 사용하는데, 이 예제는 사용하지 않으므로 아무 숫자나 입력해도 됨.
